...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.title': 'The Perfect Wedding,<br/><span class="script">Planned with Love</span>',
      'hero.subtitle': 'Love requires patience — and the right app. <br/>Focus on love — we\'ll take care of the rest.',
      ...
      'features.title': 'Everything you need for<br/><span class="script">your dream Wedding</span>',
      'features.subtitle': 'From the first idea to the last dance, <br/>Honeymooners has every tool you need <br/>to make your special day unforgettable.',
      'features.f1.title': 'Wedding Countdown', 'features.f1.desc': 'A countdown to your big day — days, hours, minutes, and seconds.',
      'features.f2.title': 'Guest Management', 'features.f2.desc': 'Manage your entire guest list with ease — all in one place.',
      'features.f3.title': 'Venue &amp; Church', 'features.f3.desc': 'Browse venues and churches — for your ceremony and reception.',
      'features.f4.title': 'Budget Tracker', 'features.f4.desc': 'Allocate spending by category and never go over budget again.',
      'features.f5.title': 'Smart Checklists', 'features.f5.desc': 'Create checklists that guide you through every planning step — so nothing important ever gets forgotten.',
      'features.f6.title': 'Service Providers', 'features.f6.desc': 'Discover and book trusted photographers, caterers, florists, and DJs.',
      'hiw.tag': 'How It Works',
      'hiw.title': 'Get started in<br /><span class="script">Three simple steps</span>',
      'hiw.subtitle': 'Planning your wedding has never been this easy.',
      'hiw.s1.title': 'Create Your Wedding', 'hiw.s1.desc': 'Sign up and set your wedding date in seconds.',
      'hiw.s2.title': 'Plan Together', 'hiw.s2.desc': 'Invite your partner and collaborate in real-time.',
      'hiw.s3.title': 'Celebrate Your Day', 'hiw.s3.desc': 'Walk down the aisle knowing every detail has been taken care of.',
      ...
      'faq.a1': 'Yes! Honeymooners is available on both iOS (App Store) and Android (Google Play). You and your partner can use it seamlessly across different devices.',
      ...
      'faq.a3': 'Your privacy is our top priority. All data is encrypted and stored securely. We never sell your personal information to third parties — ever.',
      'faq.q4': 'Can I use Honeymooners in Greek?',
      'faq.a4': 'Yes! Honeymooners fully supports English, Greek, and Cypriot Greek. Switch languages at any time from Settings — no reinstall needed.',
      ...
      'faq.a7': 'Premium subscribers enjoy offline access to their wedding data. Your checklists, guest list, and notes are always available — even without an internet connection.',
      ...
      'download.store1-sub': 'Coming Soon', 'download.store1-name': 'App Store',
      ...
      'footer.application': 'Product', 'footer.features': 'Features', 'footer.pricing': 'Pricing',
    ...
    gr: {
      'nav.features': 'Χαρακτηριστικά', 'nav.how-it-works': 'Πως Λειτουργεί', 'nav.reviews': 'Κριτικές',
      'nav.pricing': 'Τιμές', 'nav.faq': 'Ερωτήσεις', 'nav.cta': 'Ξεκινήστε',
      'hero.badge': 'Η #1 Εφαρμογή Οργάνωσης Γάμου',
      'hero.title': 'Ο Τέλειος Γάμος,<br/><span class="script">Σχεδιάζεται με Αγάπη</span>',
      'hero.subtitle': 'Η αγάπη απαιτεί υπομονή και την κατάλληλη εφαρμογή. <br/>Εστιάστε στην αγάπη — εμείς θα φροντίσουμε τα υπόλοιπα.',
      'hero.cta-primary': 'Ξεκινήστε',
      'hero.cta-secondary': 'Δείτε πως λειτουργεί',
      ...
      'features.subtitle': 'Από την πρώτη ιδέα μέχρι τον τελευταίο χορό, <br/>το Honeymooners έχει κάθε εργαλείο που χρειάζεστε <br/>για να κάνετε την ξεχωριστή μέρα σας αξέχαστη.',
      'features.f1.title': 'Αντίστροφη Μέτρηση', 'features.f1.desc': 'Αντίστροφη μέτρηση για τη μεγάλη μέρα σας — μέρες, ώρες, λεπτά και δευτερόλεπτα.',
      'features.f2.title': 'Διαχείριση Καλεσμένων', 'features.f2.desc': 'Διαχειριστείτε ολόκληρη τη λίστα καλεσμένων σας εύκολα — όλα σε ένα μέρος.',
      'features.f3.title': 'Χώρος &amp; Εκκλησία', 'features.f3.desc': 'Περιηγηθείτε σε χώρους δεξιώσεων και εκκλησίες — για την τελετή και τη δεξίωσή σας.',
      'features.f4.title': 'Παρακολούθηση Προϋπολογισμού', 'features.f4.desc': 'Κατανείμετε δαπάνες ανά κατηγορία και μην υπερβαίνετε ποτέ τον προϋπολογισμό.',
      'features.f5.title': 'Έξυπνες Λίστες', 'features.f5.desc': 'Δημιουργήστε λίστες όπου θα σας οδηγούν σε κάθε βήμα του σχεδιασμού σας — ώστε τίποτα σημαντικό να μην ξεχαστεί.',
      'features.f6.title': 'Πάροχοι Υπηρεσιών', 'features.f6.desc': 'Ανακαλύψτε και κλείστε αξιόπιστο φωτογράφο, catering, ανθοπώλη και DJ.',
      'hiw.tag': 'Πώς Λειτουργεί',
      'hiw.title': 'Ξεκινήστε σε<br /><span class="script">Τρία απλά βήματα</span>',
      'hiw.subtitle': 'Ποτέ δεν ήταν τόσο εύκολο να οργανώσετε τον γάμο σας.',
      'hiw.s1.title': 'Δημιουργία Γάμου', 'hiw.s1.desc': 'Εγγραφείτε και ορίστε την ημερομηνία του γάμου σας σε δευτερόλεπτα.',
      'hiw.s2.title': 'Σχεδιάστε Μαζί', 'hiw.s2.desc': 'Καλέστε τον/την σύντροφό σας και συνεργαστείτε σε πραγματικό χρόνο.',
      'hiw.s3.title': 'Γιορτάστε την Ημέρα σας', 'hiw.s3.desc': 'Ανεβείτε τα σκαλιά, γνωρίζοντας ότι κάθε λεπτομέρεια έχει φροντιστεί.',
      ...
      'download.store1-sub': 'Έρχεται', 'download.store1-name': 'App Store',
      ...
      'footer.application': 'Η εφαρμογή', 'footer.features': 'Χαρακτηριστικά', 'footer.pricing': 'Τιμές',
      ...
      'footer.copy': '© 2026 Honeymooners. Με επιφύλαξη παντός δικαιώματος. Φτιαγμένο με ❤️ για όλα τα ζευγάρια.',
  ...
  /* ---------- Auto Update Copyright Year ---------- */
  const yearSpan = document.querySelector('[data-i18n="footer.copy"]');

  if (yearSpan) {
    const currentYear = new Date().getFullYear();
    yearSpan.innerHTML = yearSpan.innerHTML.replace(/\d{4}/, String(currentYear));
  }
